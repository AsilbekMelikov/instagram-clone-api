...
ORDINARY_USER = "ordinary_user" # EXPORT qilinadi
MANAGER = "manager"
ADMIN = "admin"
VIA_EMAIL, VIA_PHONE = ("via email", "via phone")

NEW, CODE_VERIFIED, DONE, PHOTO_STEP = ("new", "code_verified", "done", "photo_step")

class User(AbstractUser, BaseModel):
    USER_ROLES = (
        (ORDINARY_USER, ORDINARY_USER), # Agar to'g'ridan-to'g'ri string qilsak, EXPORT qila olmaymiz
        (MANAGER, MANAGER),
        (ADMIN, ADMIN)
    )
    AUTH_TYPE_CHOICES = (
